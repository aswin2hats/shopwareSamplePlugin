import template from './sw-cms-el-config-collection-form.html.twig';
import './sw-cms-el-config-collection-form.scss';

const { Component, Mixin } = Shopware;

Component.register('sw-cms-el-config-collection-form', {
    template,
